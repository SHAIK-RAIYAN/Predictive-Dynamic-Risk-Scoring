...
/**
 * Entity represents users, servers, and other assets monitored for risk assessment
 */
@Entity
@Table(name = "entities")
...
public class Entity {
    ...
    public Entity(String entityId, String name, EntityType type, String department) {
